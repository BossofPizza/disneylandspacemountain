...
months_data = {
    'January': 'Peter Pans Flight, January 2024, Disneyland.csv',
    'February': 'Peter Pans Flight, February 2024, Disneyland.csv',
    'March': 'Peter Pans Flight, March 2024, Disneyland.csv',
    'April': 'Peter Pans Flight, April 2024, Disneyland.csv',
    'June': 'Peter Pans Flight, June 2024, Disneyland.csv',
    'July': 'Peter Pans Flight, July 2024, Disneyland.csv',
    'August': 'Peter Pans Flight, August 2024, Disneyland.csv',
    'September': 'Peter Pans Flight, September 2024, Disneyland.csv',
    'October': 'Peter Pans Flight, October 2024, Disneyland.csv',
    'November': 'Peter Pans Flight, November 2024, Disneyland.csv',
    'December': 'Peter Pans Flight, December 2024, Disneyland.csv',
}
...
title = f"Peter Pans Flight: {current_day}"
message = f"Peter Pans Flight {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
