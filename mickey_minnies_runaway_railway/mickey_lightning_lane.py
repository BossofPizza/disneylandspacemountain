...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Mickey Minnies Runaway Railway
        for ride in ride_name_elements:
            ride_name = ride.get_text(strip=True)

            if ride_name == "Mickey Minnies Runaway Railway":
                ...
                if lightning_lane_time == "closed":
                    message = "Mickey Minnies Runaway Railway's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Mickey Minnies Runaway Railway Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Mickey Minnies Runaway Railway
