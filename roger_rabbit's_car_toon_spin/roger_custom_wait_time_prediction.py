    ...
    def calculate_average_wait_time(self, timezone='US/Pacific'):
        ...
        for month_name, csv_path in self.data_paths.items():
            try:
                ...
                df['Date/Time'] = df['Date/Time'].dt.tz_localize('UTC').dt.tz_convert(timezone)
...
data_paths = {
    'January': 'Roger Rabbit's Car Toon Spin, January 2024, Disneyland.csv',
    'February': 'Roger Rabbit's Car Toon Spin, February 2024, Disneyland.csv',
    'March': 'Roger Rabbit's Car Toon Spin, March 2024, Disneyland.csv',
    'April': 'Roger Rabbit's Car Toon Spin, April 2024, Disneyland.csv',
    'June': 'Roger Rabbit's Car Toon Spin, June 2024, Disneyland.csv',
    'July': 'Roger Rabbit's Car Toon Spin, July 2024, Disneyland.csv',
    'August': 'Roger Rabbit's Car Toon Spin, August 2024, Disneyland.csv',
    'September': 'Roger Rabbit's Car Toon Spin, September 2024, Disneyland.csv',
    'October': 'Roger Rabbit's Car Toon Spin, October 2024, Disneyland.csv',
    'November': 'Roger Rabbit's Car Toon Spin, November 2024, Disneyland.csv',
    'December': 'Roger Rabbit's Car Toon Spin, December 2024, Disneyland.csv',
}
...
if average_wait_time is not None:
    title = "Roger Rabbit's Car Toon Spin Wait Time Prediction"
