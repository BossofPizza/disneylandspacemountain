...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Jungle Cruise
        for ride in ride_name_elements:
            ...
            if ride_name == "Jungle Cruise":
                ...
                if lightning_lane_time == "closed":
                    message = "Jungle Cruise's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Jungle Cruise Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Jungle Cruise
