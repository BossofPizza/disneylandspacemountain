...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Alice in Wonderland
        for ride in ride_name_elements:
            ...
            if ride_name == "Alice in Wonderland":
                ...
                if lightning_lane_time == "closed":
                    message = "Alice in Wonderland's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Alice in Wonderland Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Alice in Wonderland
