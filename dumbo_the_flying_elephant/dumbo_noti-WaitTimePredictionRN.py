...
months_data = {
    'January': 'Dumbo The Flying Elephant, January 2024, Disneyland.csv',
    'February': 'Dumbo The Flying Elephant, February 2024, Disneyland.csv',
    'March': 'Dumbo The Flying Elephant, March 2024, Disneyland.csv',
    'April': 'Dumbo The Flying Elephant, April 2024, Disneyland.csv',
    'June': 'Dumbo The Flying Elephant, June 2024, Disneyland.csv',
    'July': 'Dumbo The Flying Elephant, July 2024, Disneyland.csv',
    'August': 'Dumbo The Flying Elephant, August 2024, Disneyland.csv',
    'September': 'Dumbo The Flying Elephant, September 2024, Disneyland.csv',
    'October': 'Dumbo The Flying Elephant, October 2024, Disneyland.csv',
    'November': 'Dumbo The Flying Elephant, November 2024, Disneyland.csv',
    'December': 'Dumbo The Flying Elephant, December 2024, Disneyland.csv',
}
...
title = f"Dumbo The Flying Elephant: {current_day}"
message = f"Dumbo The Flying Elephant {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
