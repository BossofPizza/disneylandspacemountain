...
title = f"Chip 'n' Dale's GADGETcoaster: {current_day}"
message = f"Chip 'n' Dale's GADGETcoaster {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
