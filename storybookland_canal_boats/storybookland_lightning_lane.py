...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Storybookland Canal Boats
        for ride in ride_name_elements:
            ...
            if ride_name == "Storybookland Canal Boats":
                ...
                if lightning_lane_time == "closed":
                    message = "Storybookland Canal Boats's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Storybookland Canal Boats Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Storybookland Canal Boats
