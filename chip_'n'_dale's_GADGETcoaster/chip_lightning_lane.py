...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Chip 'n' Dale's GADGETcoaster
        for ride in ride_name_elements:
            ride_name = ride.get_text(strip=True)

            if ride_name == "Chip 'n' Dale's GADGETcoaster":
                ...
                if lightning_lane_time == "closed":
                    message = "Chip 'n' Dale's GADGETcoaster's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Chip 'n' Dale's GADGETcoaster Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Chip 'n' Dale's GADGETcoaster
