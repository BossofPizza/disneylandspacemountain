...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Tianas Bayou Adventure
        for ride in ride_name_elements:
            ride_name = ride.get_text(strip=True)

            if ride_name == "Tianas Bayou Adventure":
                ...
                if lightning_lane_time == "closed":
                    message = "Tianas Bayou Adventure's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Tianas Bayou Adventure Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Tianas Bayou Adventure
