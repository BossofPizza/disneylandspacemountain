...
months_data = {
    'January': 'Haunted Mansion, January 2024, Disneyland.csv',
    'February': 'Haunted Mansion, February 2024, Disneyland.csv',
    'March': 'Haunted Mansion, March 2024, Disneyland.csv',
    'April': 'Haunted Mansion, April 2024, Disneyland.csv',
    'June': 'Haunted Mansion, June 2024, Disneyland.csv',
    'July': 'Haunted Mansion, July 2024, Disneyland.csv',
    'August': 'Haunted Mansion, August 2024, Disneyland.csv',
    'September': 'Haunted Mansion, September 2024, Disneyland.csv',
    'October': 'Haunted Mansion, October 2024, Disneyland.csv',
    'November': 'Haunted Mansion, November 2024, Disneyland.csv',
    'December': 'Haunted Mansion, December 2024, Disneyland.csv',
}
...
title = f"Haunted Mansion: {current_day}"
message = f"Haunted Mansion {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
