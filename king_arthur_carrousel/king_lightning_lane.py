...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find King Arthur Carrousel
        for ride in ride_name_elements:
            ...
            if ride_name == "King Arthur Carrousel":
                ...
                if lightning_lane_time == "closed":
                    message = "King Arthur Carrousel's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "King Arthur Carrousel Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find King Arthur Carrousel
