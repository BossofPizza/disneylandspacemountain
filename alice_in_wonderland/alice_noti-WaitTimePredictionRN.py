...
months_data = {
    'January': 'Alice in Wonderland, January 2024, Disneyland.csv',
    'February': 'Alice in Wonderland, February 2024, Disneyland.csv',
    'March': 'Alice in Wonderland, March 2024, Disneyland.csv',
    'April': 'Alice in Wonderland, April 2024, Disneyland.csv',
    'June': 'Alice in Wonderland, June 2024, Disneyland.csv',
    'July': 'Alice in Wonderland, July 2024, Disneyland.csv',
    'August': 'Alice in Wonderland, August 2024, Disneyland.csv',
    'September': 'Alice in Wonderland, September 2024, Disneyland.csv',
    'October': 'Alice in Wonderland, October 2024, Disneyland.csv',
    'November': 'Alice in Wonderland, November 2024, Disneyland.csv',
    'December': 'Alice in Wonderland, December 2024, Disneyland.csv',
}
...
title = f"Alice in Wonderland: {current_day}"
message = f"Alice in Wonderland {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
