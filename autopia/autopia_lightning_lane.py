...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Autopia
        for ride in ride_name_elements:
            ...
            if ride_name == "Autopia":
                ...
                if lightning_lane_time == "closed":
                    message = "Autopia's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Autopia Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Autopia
