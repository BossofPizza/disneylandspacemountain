...
title = f"Mickey Minnies Runaway Railway: {current_day}"
message = f"Mickey Minnies Runaway Railway {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
