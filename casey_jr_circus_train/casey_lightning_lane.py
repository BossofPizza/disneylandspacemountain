...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Casey Jr Circus Train
        for ride in ride_name_elements:
            ...
            if ride_name == "Casey Jr Circus Train":
                ...
                if lightning_lane_time == "closed":
                    message = "Casey Jr Circus Train's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Casey Jr Circus Train Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Casey Jr Circus Train
