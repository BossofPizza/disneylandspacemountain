...
months_data = {
    'January': 'Mr Toads Wild Ride, January 2024, Disneyland.csv',
    'February': 'Mr Toads Wild Ride, February 2024, Disneyland.csv',
    'March': 'Mr Toads Wild Ride, March 2024, Disneyland.csv',
    'April': 'Mr Toads Wild Ride, April 2024, Disneyland.csv',
    'June': 'Mr Toads Wild Ride, June 2024, Disneyland.csv',
    'July': 'Mr Toads Wild Ride, July 2024, Disneyland.csv',
    'August': 'Mr Toads Wild Ride, August 2024, Disneyland.csv',
    'September': 'Mr Toads Wild Ride, September 2024, Disneyland.csv',
    'October': 'Mr Toads Wild Ride, October 2024, Disneyland.csv',
    'November': 'Mr Toads Wild Ride, November 2024, Disneyland.csv',
    'December': 'Mr Toads Wild Ride, December 2024, Disneyland.csv',
}
...
title = f"Mr Toads Wild Ride: {current_day}"
message = f"Mr Toads Wild Ride {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
