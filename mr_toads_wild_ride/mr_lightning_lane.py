...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Mr Toads Wild Ride
        for ride in ride_name_elements:
            ...
            if ride_name == "Mr Toads Wild Ride":
                ...
                if lightning_lane_time == "closed":
                    message = "Mr Toads Wild Ride's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Mr Toads Wild Ride Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Mr Toads Wild Ride
