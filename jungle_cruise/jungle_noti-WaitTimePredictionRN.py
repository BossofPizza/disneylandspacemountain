...
months_data = {
    'January': 'Jungle Cruise, January 2024, Disneyland.csv',
    'February': 'Jungle Cruise, February 2024, Disneyland.csv',
    'March': 'Jungle Cruise, March 2024, Disneyland.csv',
    'April': 'Jungle Cruise, April 2024, Disneyland.csv',
    'June': 'Jungle Cruise, June 2024, Disneyland.csv',
    'July': 'Jungle Cruise, July 2024, Disneyland.csv',
    'August': 'Jungle Cruise, August 2024, Disneyland.csv',
    'September': 'Jungle Cruise, September 2024, Disneyland.csv',
    'October': 'Jungle Cruise, October 2024, Disneyland.csv',
    'November': 'Jungle Cruise, November 2024, Disneyland.csv',
    'December': 'Jungle Cruise, December 2024, Disneyland.csv',
}
...
title = f"Jungle Cruise: {current_day}"
message = f"Jungle Cruise {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
