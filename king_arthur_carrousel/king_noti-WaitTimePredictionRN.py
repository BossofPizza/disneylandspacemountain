...
months_data = {
    'January': 'King Arthur Carrousel, January 2024, Disneyland.csv',
    'February': 'King Arthur Carrousel, February 2024, Disneyland.csv',
    'March': 'King Arthur Carrousel, March 2024, Disneyland.csv',
    'April': 'King Arthur Carrousel, April 2024, Disneyland.csv',
    'June': 'King Arthur Carrousel, June 2024, Disneyland.csv',
    'July': 'King Arthur Carrousel, July 2024, Disneyland.csv',
    'August': 'King Arthur Carrousel, August 2024, Disneyland.csv',
    'September': 'King Arthur Carrousel, September 2024, Disneyland.csv',
    'October': 'King Arthur Carrousel, October 2024, Disneyland.csv',
    'November': 'King Arthur Carrousel, November 2024, Disneyland.csv',
    'December': 'King Arthur Carrousel, December 2024, Disneyland.csv',
}
...
title = f"King Arthur Carrousel: {current_day}"
message = f"King Arthur Carrousel {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
