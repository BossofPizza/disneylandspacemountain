...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Astro Orbitor
        for ride in ride_name_elements:
            ...
            if ride_name == "Astro Orbitor":
                ...
                if lightning_lane_time == "closed":
                    message = "Astro Orbitor's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Astro Orbitor Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Astro Orbitor
