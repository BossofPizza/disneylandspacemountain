...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Star Tours
        for ride in ride_name_elements:
            ...
            if ride_name == "Star Tours":
                ...
                if lightning_lane_time == "closed":
                    message = "Star Tours's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Star Tours Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Star Tours
