...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Dumbo The Flying Elephant
        for ride in ride_name_elements:
            ...
            if ride_name == "Dumbo The Flying Elephant":
                ...
                if lightning_lane_time == "closed":
                    message = "Dumbo The Flying Elephant's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Dumbo The Flying Elephant Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Dumbo The Flying Elephant
