...
title = f"Roger Rabbit's Car Toon Spin: {current_day}"
message = f"Roger Rabbit's Car Toon Spin {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
