...
months_data = {
    'January': 'Autopia, January 2024, Disneyland.csv',
    'February': 'Autopia, February 2024, Disneyland.csv',
    'March': 'Autopia, March 2024, Disneyland.csv',
    'April': 'Autopia, April 2024, Disneyland.csv',
    'June': 'Autopia, June 2024, Disneyland.csv',
    'July': 'Autopia, July 2024, Disneyland.csv',
    'August': 'Autopia, August 2024, Disneyland.csv',
    'September': 'Autopia, September 2024, Disneyland.csv',
    'October': 'Autopia, October 2024, Disneyland.csv',
    'November': 'Autopia, November 2024, Disneyland.csv',
    'December': 'Autopia, December 2024, Disneyland.csv',
}
...
title = f"Autopia: {current_day}"
message = f"Autopia {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
