...
months_data = {
    'January': 'Storybookland Canal Boats, January 2024, Disneyland.csv',
    'February': 'Storybookland Canal Boats, February 2024, Disneyland.csv',
    'March': 'Storybookland Canal Boats, March 2024, Disneyland.csv',
    'April': 'Storybookland Canal Boats, April 2024, Disneyland.csv',
    'June': 'Storybookland Canal Boats, June 2024, Disneyland.csv',
    'July': 'Storybookland Canal Boats, July 2024, Disneyland.csv',
    'August': 'Storybookland Canal Boats, August 2024, Disneyland.csv',
    'September': 'Storybookland Canal Boats, September 2024, Disneyland.csv',
    'October': 'Storybookland Canal Boats, October 2024, Disneyland.csv',
    'November': 'Storybookland Canal Boats, November 2024, Disneyland.csv',
    'December': 'Storybookland Canal Boats, December 2024, Disneyland.csv',
}
...
title = f"Storybookland Canal Boats: {current_day}"
message = f"Storybookland Canal Boats {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
