...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Finding Nemo Submarine Voyage
        for ride in ride_name_elements:
            ...
            if ride_name == "Finding Nemo Submarine Voyage":
                ...
                if lightning_lane_time == "closed":
                    message = "Finding Nemo Submarine Voyage's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Finding Nemo Submarine Voyage Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Finding Nemo Submarine Voyage
