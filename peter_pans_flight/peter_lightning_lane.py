...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Peter Pans Flight
        for ride in ride_name_elements:
            ...
            if ride_name == "Peter Pans Flight":
                ...
                if lightning_lane_time == "closed":
                    message = "Peter Pans Flight's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Peter Pans Flight Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Peter Pans Flight
