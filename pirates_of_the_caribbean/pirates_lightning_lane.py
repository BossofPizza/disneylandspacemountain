...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Pirates of the Caribbean
        for ride in ride_name_elements:
            ...
            if ride_name == "Pirates of the Caribbean":
                ...
                if lightning_lane_time == "closed":
                    message = "Pirates of the Caribbean's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Pirates of the Caribbean Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Pirates of the Caribbean
