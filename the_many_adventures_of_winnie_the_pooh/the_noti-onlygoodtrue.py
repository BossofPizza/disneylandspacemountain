...
# Define the URL for the The Many Adventures of Winnie the Pooh wait times page
...
months_data = {
    'January': 'The Many Adventures of Winnie the Pooh, January 2024, Disneyland.csv',
    'February': 'The Many Adventures of Winnie the Pooh, February 2024, Disneyland.csv',
    'March': 'The Many Adventures of Winnie the Pooh, March 2024, Disneyland.csv',
    'April': 'The Many Adventures of Winnie the Pooh, April 2024, Disneyland.csv',
    'June': 'The Many Adventures of Winnie the Pooh, June 2024, Disneyland.csv',
    'July': 'The Many Adventures of Winnie the Pooh, July 2024, Disneyland.csv',
    'August': 'The Many Adventures of Winnie the Pooh, August 2024, Disneyland.csv',
    'September': 'The Many Adventures of Winnie the Pooh, September 2024, Disneyland.csv',
    'October': 'The Many Adventures of Winnie the Pooh, October 2024, Disneyland.csv',
    'November': 'The Many Adventures of Winnie the Pooh, November 2024, Disneyland.csv',
    'December': 'The Many Adventures of Winnie the Pooh, December 2024, Disneyland.csv',
}
...
while True:
    ...
    try:
        ...
        for ride in ride_name_elements:
            ...
            if ride_name == "The Many Adventures of Winnie the Pooh":
    ...
    if difference > 10:
        if not notified_good_time:
            ...
            title = f"The Many Adventures of Winnie the Pooh: {current_day}"
