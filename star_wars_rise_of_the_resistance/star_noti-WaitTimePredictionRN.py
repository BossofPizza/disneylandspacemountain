...
months_data = {
    'January': 'Star Wars Rise of the Resistance, January 2024, Disneyland.csv',
    'February': 'Star Wars Rise of the Resistance, February 2024, Disneyland.csv',
    'March': 'Star Wars Rise of the Resistance, March 2024, Disneyland.csv',
    'April': 'Star Wars Rise of the Resistance, April 2024, Disneyland.csv',
    'June': 'Star Wars Rise of the Resistance, June 2024, Disneyland.csv',
    'July': 'Star Wars Rise of the Resistance, July 2024, Disneyland.csv',
    'August': 'Star Wars Rise of the Resistance, August 2024, Disneyland.csv',
    'September': 'Star Wars Rise of the Resistance, September 2024, Disneyland.csv',
    'October': 'Star Wars Rise of the Resistance, October 2024, Disneyland.csv',
    'November': 'Star Wars Rise of the Resistance, November 2024, Disneyland.csv',
    'December': 'Star Wars Rise of the Resistance, December 2024, Disneyland.csv',
}
...
title = f"Star Wars Rise of the Resistance: {current_day}"
message = f"Star Wars Rise of the Resistance {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
