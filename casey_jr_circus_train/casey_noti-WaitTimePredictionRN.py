...
months_data = {
    'January': 'Casey Jr. Circus Train, January 2024, Disneyland.csv',
    'February': 'Casey Jr. Circus Train, February 2024, Disneyland.csv',
    'March': 'Casey Jr. Circus Train, March 2024, Disneyland.csv',
    'April': 'Casey Jr. Circus Train, April 2024, Disneyland.csv',
    'June': 'Casey Jr. Circus Train, June 2024, Disneyland.csv',
    'July': 'Casey Jr. Circus Train, July 2024, Disneyland.csv',
    'August': 'Casey Jr. Circus Train, August 2024, Disneyland.csv',
    'September': 'Casey Jr. Circus Train, September 2024, Disneyland.csv',
    'October': 'Casey Jr. Circus Train, October 2024, Disneyland.csv',
    'November': 'Casey Jr. Circus Train, November 2024, Disneyland.csv',
    'December': 'Casey Jr. Circus Train, December 2024, Disneyland.csv',
}
...
title = f"Casey Jr Circus Train: {current_day}"
message = f"Casey Jr Circus Train {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
