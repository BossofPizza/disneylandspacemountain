...
title = f"Indiana Jones Adventure: {current_day}"
message = f"Indiana Jones Adventure {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
