...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Haunted Mansion
        for ride in ride_name_elements:
            ...
            if ride_name == "Haunted Mansion":
                ...
                if lightning_lane_time == "closed":
                    message = "Haunted Mansion's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Haunted Mansion Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Haunted Mansion
