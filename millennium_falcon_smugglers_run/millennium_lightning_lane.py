...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Millennium Falcon Smugglers Run
        for ride in ride_name_elements:
            ride_name = ride.get_text(strip=True)

            if ride_name == "Millennium Falcon Smugglers Run":
                ...
                if lightning_lane_time == "closed":
                    message = "Millennium Falcon Smugglers Run's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Millennium Falcon Smugglers Run Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Millennium Falcon Smugglers Run
