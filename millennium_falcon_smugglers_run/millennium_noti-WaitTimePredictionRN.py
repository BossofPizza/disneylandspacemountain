...
title = f"Millennium Falcon Smugglers Run: {current_day}"
message = f"Millennium Falcon Smugglers Run {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
