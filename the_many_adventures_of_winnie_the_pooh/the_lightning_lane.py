...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find The Many Adventures of Winnie the Pooh
        for ride in ride_name_elements:
            ...
            if ride_name == "The Many Adventures of Winnie the Pooh":
                ...
                if lightning_lane_time == "closed":
                    message = "The Many Adventures of Winnie the Pooh's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "The Many Adventures of Winnie the Pooh Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find The Many Adventures of Winnie the Pooh
