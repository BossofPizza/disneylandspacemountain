...
months_data = {
    'January': 'Mad Tea Party, January 2024, Disneyland.csv',
    'February': 'Mad Tea Party, February 2024, Disneyland.csv',
    'March': 'Mad Tea Party, March 2024, Disneyland.csv',
    'April': 'Mad Tea Party, April 2024, Disneyland.csv',
    'June': 'Mad Tea Party, June 2024, Disneyland.csv',
    'July': 'Mad Tea Party, July 2024, Disneyland.csv',
    'August': 'Mad Tea Party, August 2024, Disneyland.csv',
    'September': 'Mad Tea Party, September 2024, Disneyland.csv',
    'October': 'Mad Tea Party, October 2024, Disneyland.csv',
    'November': 'Mad Tea Party, November 2024, Disneyland.csv',
    'December': 'Mad Tea Party, December 2024, Disneyland.csv',
}
...
title = f"Mad Tea Party: {current_day}"
message = f"Mad Tea Party {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
