...
months_data = {
    'January': 'Pirates of the Caribbean, January 2024, Disneyland.csv',
    'February': 'Pirates of the Caribbean, February 2024, Disneyland.csv',
    'March': 'Pirates of the Caribbean, March 2024, Disneyland.csv',
    'April': 'Pirates of the Caribbean, April 2024, Disneyland.csv',
    'June': 'Pirates of the Caribbean, June 2024, Disneyland.csv',
    'July': 'Pirates of the Caribbean, July 2024, Disneyland.csv',
    'August': 'Pirates of the Caribbean, August 2024, Disneyland.csv',
    'September': 'Pirates of the Caribbean, September 2024, Disneyland.csv',
    'October': 'Pirates of the Caribbean, October 2024, Disneyland.csv',
    'November': 'Pirates of the Caribbean, November 2024, Disneyland.csv',
    'December': 'Pirates of the Caribbean, December 2024, Disneyland.csv',
}
...
title = f"Pirates of the Caribbean: {current_day}"
message = f"Pirates of the Caribbean {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
