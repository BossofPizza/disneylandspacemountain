...
def send_notification():
    try:
        ...
        # Iterate through all found ride names to find Buzz Lightyear Astro Blasters
        for ride in ride_name_elements:
            ...
            if ride_name == "Buzz Lightyear Astro Blasters":
                ...
                if lightning_lane_time == "closed":
                    message = "Buzz Lightyear Astro Blasters's Lightning Lane is currently closed."
                else:
                ...
                pushover_response = httpx.post(
                    ...
                    data={
                        "token": api_token,
                        "user": user_key,
                        "title": "Buzz Lightyear Astro Blasters Lightning Lane Wait Time",
                        "message": message
                    }
                )
                ...
                break  # Exit the loop once we find Buzz Lightyear Astro Blasters
