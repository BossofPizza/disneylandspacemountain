...
months_data = {
    'January': 'Finding Nemo Submarine Voyage, January 2024, Disneyland.csv',
    'February': 'Finding Nemo Submarine Voyage, February 2024, Disneyland.csv',
    'March': 'Finding Nemo Submarine Voyage, March 2024, Disneyland.csv',
    'April': 'Finding Nemo Submarine Voyage, April 2024, Disneyland.csv',
    'June': 'Finding Nemo Submarine Voyage, June 2024, Disneyland.csv',
    'July': 'Finding Nemo Submarine Voyage, July 2024, Disneyland.csv',
    'August': 'Finding Nemo Submarine Voyage, August 2024, Disneyland.csv',
    'September': 'Finding Nemo Submarine Voyage, September 2024, Disneyland.csv',
    'October': 'Finding Nemo Submarine Voyage, October 2024, Disneyland.csv',
    'November': 'Finding Nemo Submarine Voyage, November 2024, Disneyland.csv',
    'December': 'Finding Nemo Submarine Voyage, December 2024, Disneyland.csv',
}
...
title = f"Finding Nemo Submarine Voyage: {current_day}"
message = f"Finding Nemo Submarine Voyage {current_day} in {current_month} at {current_hour}:00 PT is {predicted_time:.2f} minutes."
